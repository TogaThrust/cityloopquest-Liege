/**
 * Réécrit les descriptions POI Liège en textes visiteurs, sans formulation interne.
 * Usage: node scripts/rewrite-liege-poi-descriptions.mjs
 */
import fs from "fs";
