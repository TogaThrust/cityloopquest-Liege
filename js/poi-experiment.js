...
(function () {
  ...
  const CITY_CONFIG = {
    ...
    defaultCenter: { lat: Number("50.6451"), lng: Number("5.5737") },
    lastPosKey: "liege_lastKnownPosition",
    cityKey: "liege",
  ...
  function isWalkInProgress() {
    return (
      ...
      localStorage.getItem("liege_walkInProgress") === "true" ||
  ...
  function updateTourSavedSummary() {
    ...
    if (!el) return;
    const idxRaw = localStorage.getItem("liege_currentIndex");
    const scoreRaw = localStorage.getItem("liege_score");
